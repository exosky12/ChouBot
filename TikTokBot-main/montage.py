...
for i in range(number_video):
    colors = ["indianred", "cadetblue", "lightgreen", "lightcoral", "cornflowerblue"]
    ...
    if randomColor == 1:
        ...
        os.system("""ffmpeg -i ./video/video""" + str(i+1) + """.mp4 -vf "scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:-1:-1:color="cadetblue ./tmp/video""" + str(i+1) +""".mp4""")
    elif randomColor == 3:
        os.system("""ffmpeg -i ./video/video""" + str(i+1) + """.mp4 -vf "scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:-1:-1:color="lightgreen ./tmp/video""" + str(i+1) +""".mp4""")
    elif randomColor == 4:
        os.system("""ffmpeg -i ./video/video""" + str(i+1) + """.mp4 -vf "scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:-1:-1:color="lightcoral ./tmp/video""" + str(i+1) +""".mp4""")
    else:
        os.system("""ffmpeg -i ./video/video""" + str(i+1) + """.mp4 -vf "scale=1080:1920:force_original_aspect_ratio=decrease,pad=1080:1920:-1:-1:color="cornflowerblue ./tmp/video""" + str(i+1) +""".mp4""") 
...
for i in range(number_video):
    n.write("timecode"+ str(i+1) + "= int(clip"+ str(i+1)+""".duration)
""")
